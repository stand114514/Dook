...
def newss(qq):
    ...
    arial_1 = ImageFont.truetype('fonts\SourceHanSansCN-Bold.otf',25) #字体路径
    ...
    arial_1 = ImageFont.truetype('fonts\SourceHanSansCN-Bold.otf',25) 
    draw.text((167,383),txt,font =arial_1, fill='#F5F5F5') 

    arial_2 = ImageFont.truetype('fonts\SourceHanSansCN-Bold.otf',30)
